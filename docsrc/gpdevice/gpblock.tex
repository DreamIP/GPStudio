...
\command{\textbf{\tool{} addcomponent} -n <component-driver>}
...
\paramcommand{
-n & name of the component driver & gp\_fifo \\
}

\begin{sampletitle}
> \textbf{\tool{} addcomponent} -n gp\_fifo
\end{sampletitle}
\samplecomment{Add the support for a gp\_fifo inside this \kind{}}

% ==============================================
\subsubsection{delcomponent}
\label{subsec:delcomponent}
\command{\textbf{\tool{} delcomponent} -n <component-driver>}
...
\end{sampletitle}
\samplecomment{Remove the support of gp\_fifo inside this \kind{}}

% ==============================================
\subsubsection{showcomponent}
\label{subsec:showcomponent}
\command{\textbf{\tool{} showcomponent}}
...
components :\\
  ...
  + gp\_dcfifo
\end{sampletitle}
\samplecomment{Print the list of components support.}
